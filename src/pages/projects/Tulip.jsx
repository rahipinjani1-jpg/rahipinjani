...
const HERO = "/images/tulip/hero.png";

const PROCESS = [
  { src: "/images/tulip/process-1.png", label: "Composing the Motif" },
  { src: "/images/tulip/process-2.png", label: "Painting the Stems" },
];
...
export default function Tulip({ onBack }) {
  const p = projects.find((x) => x.slug === "tulip");
  return (
