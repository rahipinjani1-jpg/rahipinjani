...
const HERO = "/images/kurti/hero.png";

const PROCESS = [
  { src: "/images/kurti/process-1.png", label: "Chalk Tracing on Hoop" },
  { src: "/images/kurti/process-2.png", label: "Hand Embroidering" },
  { src: "/images/kurti/process-3.png", label: "Pearl-Centred Roses" },
  { src: "/images/kurti/process-4.png", label: "Rajasthani Doll Tassels" },
];
...
export default function Kurti({ onBack }) {
  const p = projects.find((x) => x.slug === "kurti");
  return (
