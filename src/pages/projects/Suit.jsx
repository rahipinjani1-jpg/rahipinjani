...
const HERO = "/images/suit/hero.png";
...
export default function Suit({ onBack }) {
  const p = projects.find((x) => x.slug === "suit");
  return (
    <section className="pt-17">
      ...
      <div className="px-8 md:px-15 py-14 md:py-20 bg-cream">
        ...
        <div className="max-w-100">
          <img
            src="/images/suit/reference.png"
            alt="Design illustration"
            className="w-full h-140 object-cover object-top block transition-transform duration-400 hover:scale-[1.02] "
          />
          <p className="text-[11px] text-muted tracking-widest uppercase mt-3">
            Concept rendered through creative direction
          </p>
        </div>
      </div>
